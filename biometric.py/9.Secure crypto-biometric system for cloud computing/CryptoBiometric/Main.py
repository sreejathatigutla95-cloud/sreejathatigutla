...
main = tkinter.Tk()
main.title("Robust Biometric-Cryptography Integration for Cloud Security")
...
def GUI():
    ...
    font = ('times', 16, 'bold')
    title = Label(main, text='Robust Biometric-Cryptography Integration for Cloud Security')
